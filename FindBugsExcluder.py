...
xml_buglist = 'findbugs.xml' #'generics.D:\\aaa-TIJ4\\code\\findbugs.xml'
text_buglist = 'findbugs.txt' # 'generics.D:\\aaa-TIJ4\\code\\findbugs.txt'
findbugs_filter = 'FindBugsFilter-auto.xml' # 'generics.D:\\aaa-TIJ4\\code\\FindBugsFilter-auto.xml'
